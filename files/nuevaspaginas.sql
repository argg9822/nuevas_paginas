...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 29, 2023 at 03:11 AM
...
--
-- Table structure for table `ventas_tmp`
--
...
--
-- AUTO_INCREMENT for table `ventas_tmp`
--
ALTER TABLE `ventas_tmp`
  MODIFY `idVenta` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `registroventas`
  ADD CONSTRAINT `registroventas_ibfk_1` FOREIGN KEY (`idProducto`) REFERENCES `inventario` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `registroventas_ibfk_2` FOREIGN KEY (`producto`) REFERENCES `inventario` (`descripcion`) ON UPDATE CASCADE;

--
-- Constraints for table `ventas_tmp`
--
ALTER TABLE `ventas_tmp`
  ADD CONSTRAINT `ventas_tmp_ibfk_1` FOREIGN KEY (`idProducto`) REFERENCES `inventario` (`id`) ON UPDATE CASCADE;
COMMIT;
